...
//               });
              ...
              Navigator.push(context, MaterialPageRoute(builder: (context) => CreatePost(description: widget.description,category: widget.category,budget: widget.budget,location: widget.title,duration: widget.duration,seasons: widget.season, placesList: placesLists, timesList: timesList,),));
            },
                ...
                tabs: _dates.asMap().entries.map((entry) {
                  ...
                  return Column(
                    ...
                    children: [
                      Text(
                        'Day ${entry.key + 1}',
                        style: GoogleFonts.montserrat(fontSize: 16), // Adjust font size as needed
                      ),
                      Text(
                        formattedDate,
                        style: GoogleFonts.montserrat(fontSize: 12,fontWeight: FontWeight.w300), // Adjust font size as needed
                      ),
                    ],
                  );
                }).toList(),
        ...
        BackGround(),
          ...
          child: Column(
            children: [
              Container(
                width: double.maxFinite,
                decoration: BoxDecoration(border: Border.all(style: BorderStyle.solid,color: Colors.orange)),
                child: OutlinedButton(
                  style: ButtonStyle(backgroundColor: MaterialStatePropertyAll(Colors.transparent),side: MaterialStatePropertyAll(BorderSide.none)),
                    onPressed: () {
                      showDialog(
                        context: context,
                        builder: (BuildContext context) {
                          return AlertDialog(
                            ...
                            title: Text('New Location',style: GoogleFonts.montserrat(color: Colors.green)),
                            content: Container(
                              height: 100,
                              child: Column(
                                children: [
                                  TextField(
                                    ...
                                    onTap: () async {
                                      final selectedTime = await showTimePicker(
                                        ...
                                        builder: (BuildContext context, Widget? child) {
                                          return Theme(
                                            data: ThemeData.dark().copyWith( // Customize the colors here
                                              primaryColor: Colors.white, // Header background color
                                              accentColor: Colors.black, // Highlighted color
                                    ...
                                    decoration: InputDecoration(hintText: 'Time',hintStyle: TextStyle(color: Colors.black)),
                                  ),
                                  TextField(
                                    style: TextStyle(color: Colors.black),
                                    onChanged: (value) {
                                    ...
                                    decoration:
                                    InputDecoration(hintText: 'Place',hintStyle: TextStyle(color: Colors.black)),
                                  ),
                                ],
                              ),
                            ),
                  ...
                  itemBuilder: (context, index) {
                    return TimelineTile(
                      ...
                      beforeLineStyle: LineStyle(color:  Colors.white,thickness: 2),
                        afterLineStyle: LineStyle(color:  Colors.white,thickness: 2),
                        ...
                        endChild: Padding(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(boxShadow: [
                              //BoxShadow(color: Colors.grey[100]!,blurRadius: 2,spreadRadius: 3,offset: Offset(3, 5)),
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Text(
                                    ...
                                    style: GoogleFonts.montserrat(fontSize: 13,fontWeight: FontWeight.bold,color: Colors.grey.shade400),
                                  ),
                                  Container(
                                    ...
                                    child: Center(
                                      child: Text(
                                        ...
                                        maxLines: 3,
                                        style: GoogleFonts.montserrat(fontSize: 15,fontWeight: FontWeight.w100,color: Colors.white),
                                      ),
                                    ),
                                  ),
                                ],
